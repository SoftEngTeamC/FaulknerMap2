...
public class TextualDirectionsTest {
    ...
    public void getAngle() throws Exception {
        ...
        assertEquals(60, TextualDirections.getAngle(D, E, F), 0.1);
    }
    ...
    public void angleToDirection() throws Exception {
        ...
        assertEquals(TextualDirections.Direction.LEFT, TextualDirections.angleToDirection(1));
        assertEquals(TextualDirections.Direction.LEFT, TextualDirections.angleToDirection(160));
        assertNotEquals(TextualDirections.Direction.LEFT, TextualDirections.angleToDirection(179));
    }
